...
char *count[10000];
char *clipboard;
int len = 0 , pos_line , pos_char , Have_Space = 0 , counter_new_LINE , size , first_cur , second_cur , size_clipboard;
char bORf; 
...
void compare(){
    ...
    directory(dir_file1_1 , dir_file1_2);
    for(int i = 0 ; i < len  ; i++)
        printf("%s\n" , dir_file1_2[i]);
    go_to_root();
    ...
    printf("file opened\n");
    directory(dir_file2_1 , dir_file2_2);
    for(int i = 0 ; i < len ; i++)
        printf("%s\n" , dir_file2_2[i]);
    go_to_root();
    ...
    // go_to_root();
    // go_to_directory(dir_file1_2);
    // printf("dir 1 is : %s\ndir 2 is : %s\n" , dir_file1_2[2] , dir_file2_2[2]);
    // printf("first file lines : %d\nsecond file lines : %d\n" , line_first_file , line_second_file);